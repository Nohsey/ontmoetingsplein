...
?>
	...
	<section>
		...
		<div class="container">
			...
			<div class="row services"  style="margin-top:-500px;">

				<?php

				$count  =  $evenementdata->CountEvent1();


				for ($i=0; $i < $count; $i++) {

					$title =  $evenementdata->GetEventName1();
					$inhoud =  $evenementdata->GetEventinhoud1($title[$i][0]);
					$starttitletime = $evenementdata->GetEventBTime1($title[$i][0]);
					$eindtitletime = $evenementdata->GetEventETime1($title[$i][0]);
					$datum = $evenementdata->GetEventData1($title[$i][0]);
