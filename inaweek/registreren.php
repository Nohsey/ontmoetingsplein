...
<head>
	...
	<title>Speelwerkplaats - Registreren</title>
        ...
        <div class="container">
            <div class="row intro-tables">
                <div class="col-md-offset-2 col-md-8 col-xs-12">
                    <div align="center" class="intro-table intro-table-third" style="width: 100%; height: 100%; padding: 70px 70px;">
                      	<form action="" method="POST">
                          <h3 class="white heading" style="text-align: center;">Registreren</h3>
                          <h5 class="white heading" style="text-align: center;">Vul hieronder uw gegevens in om te registreren.</h5>
                            <input type="text" name="rfname" class="form-control form-white" placeholder="Voornaam"><br/>
                            <input type="text" name="rlname" class="form-control form-white" placeholder="Achternaam"><br/>
                            <input type="text" name="rusr" class="form-control form-white" placeholder="Gebruikersnaam"><br/>
                  					<input type="password" name="rpass" class="form-control form-white" placeholder="Wachtwoord"><br/>
                            <input type="tel" name="rtel" class="form-control form-white" placeholder="Telefoon"><br/>
                            <input type="email" name="remail" class="form-control form-white" placeholder="E-mailadres"><br/>
                  					<button type="submit" name="btRegister" class="btn btn-submit">Registreren</button><br/>
                        </form>
                    </div>
                </div>
